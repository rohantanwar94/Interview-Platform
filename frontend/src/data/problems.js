...
print(maxArea([1,1]))  # Expected: 1`,
  ...
  "move-zeroes": {
    ...
    category: "Array • Two Pointers",
    description: {
      text: "Move all 0's to the end while maintaining order of non-zero elements.",
  ...
  "merge-sorted-array": {
    ...
    expectedOutput: { javascript: "[1,2,2,3,5,6]" },
  },
  ...
  "longest-common-prefix": {
    ...
    category: "String",
    description: {
      text: "Find longest common prefix among array of strings.",
      notes: [],
    },
  ...
  "single-number": {
    ...
    description: {
      text: "Every element appears twice except one.",
      notes: ["Find that element."],
    },
  ...
  "climbing-stairs": {
    ...
    description: {
      text: "You can climb 1 or 2 steps.",
      notes: ["Return number of ways."],
    },
  ...
  "missing-number": {
    ...
    category: "Array • Math",
    description: {
      text: "Find missing number in range [0,n].",
      notes: [],
    },
  ...
  "valid-anagram": {
    ...
    description: {
      text: "Check if t is an anagram of s.",
      notes: [],
    },
